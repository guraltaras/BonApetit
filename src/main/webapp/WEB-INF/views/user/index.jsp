<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <li><a href="/admin/admin"><span class="glyphicon glyphicon-user"> </span>Admin</a></li>
    <ul>
    <c:forEach items="${categories}" var="catagory">
    	<li><a href="">${catagory.name}</a> </li>
    	
    </c:forEach>
    </ul>
    
			<h3 style="color:#00ff00">server started successfully</h3>
			<h3 style="color:#ff0000" >no errors</h3>

<br>

		<h3 style="color:#507299"><a href="/user/homework">HomeWork</a></h3>
	<br>
	<br>
...
<div class="banner-bottom">
	...
	<div class="shop">
		<a href="single.html"> COLLECTION NOW</a>
	</div>
	</div>
		</div>
